...
#define APIKEY  "1Fw70alhQfGRfER9oYcTp3XM3JFaHmNI"                        //replace API key
#define DEVICE_DEV_ID "esp321@mahendrakaira0408"      //replace device developer id

const int SEN_PIN = 15;                               // Output Pin GPIO19
SimpleDHT22 dht22(SEN_PIN);

const char ssid[] = "shavm8_2.4GHz@unifi";                 //replace wifi SSID 
const char password[] = "sha78vm08";         //replace wifi password 
